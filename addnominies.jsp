...
<p align="center" class="style2">Add New Nominies</p>
...
<form id="form1" name="form1" method="post" action="">
  <table bgcolor="#CCCCCC" width="317" height="272" border="0" align="center">
    <tr>
	 ...
	 <tr>
      <td><div align="right"><span class="style3">Nomini Adhar</span></div></td>
      <td><div align="left"><span class="style3">
   ...
   <tr>
    ...
    <tr>
      <td><p align="right" class="style3">People ID </p></td>
      <td>        
        <div align="left">
          <input type="text" name="s6" value="<%= session.getAttribute("pid") %>"/>      
        </div></td>
    </tr>
    <tr>
...
try{
int x=stmt.executeUpdate("insert into nominies(name,nomini_adhar,category,description,address,peopleid)  value('"+request.getParameter("s1")+"','"+request.getParameter("s2")+"','"+request.getParameter("s3")+"','"+request.getParameter("s4")+"','"+request.getParameter("s5")+"','"+request.getParameter("s6")+"')");
if(x!=0){
%>
<script>
